// ==UserScript==
// @name         GB Mines Map - COMPLETE Data Exporter v6.1
// @namespace    http://tampermonkey.net/
// @version      6.1
// @description  Export ALL GB mineral data - Fixed wait for data
...
(function() {
    ...
    function waitForData() {
        ...
        if (typeof Allpolygons !== 'undefined' && Allpolygons.length > 0) {
            ...
            addExportButton(); // Add button anyway, it might work later
        }
    }
    ...
    function exportCompleteDataset() {
        ...
        console.log('📍 Districts:', [...new Set(features.map(f => f.properties.district))]);
    }

    // ... (keep all the helper functions from previous version: parseCoordinates, classifyAreaType, detectDistrict, calculatePolygonArea, downloadFile, getTimestamp, validateDataCompleteness)
